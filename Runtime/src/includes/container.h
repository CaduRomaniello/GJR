...
class Container{
    ...
    public:
        ...
        virtual airplaneIterator beginAirplanes() = 0;/*!< Returns the iterator to the beginning of airplanes attribute. */
        virtual airplaneIterator endAirplanes() = 0;/*!< Returns the iterator to the end of airplanes attribute. */
        virtual flightIterator beginFlights() = 0;/*!< Returns the iterator to the beginning of flights attribute. */
        virtual flightIterator endFlights() = 0;/*!< Returns the iterator to the end of flights attribute. */
        virtual ticketIterator beginTickets() = 0;/*!< Returns the iterator to the beginning of tickets attribute. */
        virtual ticketIterator endTickets() = 0;/*!< Returns the iterator to the end of tickets attribute. */
