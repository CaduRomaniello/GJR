...
public:
    ...
    void setupUi(QMainWindow *loginScreen)
    {
        ...
        button_create_user = new QPushButton(centralwidget);
        button_create_user->setObjectName(QString::fromUtf8("button_create_user"));
        button_create_user->setGeometry(QRect(350, 440, 91, 31));
    ...
    void retranslateUi(QMainWindow *loginScreen)
    {
        ...
        button_create_user->setText(QCoreApplication::translate("loginScreen", "Create User", nullptr));
    } // retranslateUi
